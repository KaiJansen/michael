...
public class JobDatePickerDialogFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {


    public static final String TAG = JobDatePickerDialogFragment.class.getCanonicalName();
    ...
    public static JobDatePickerDialogFragment getNewInstance(int id) {
        JobDatePickerDialogFragment diaFragment = new JobDatePickerDialogFragment();
    ...
    public JobDatePickerDialogFragment() {
